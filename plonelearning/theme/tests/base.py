...
def setup_product():
    ...
    import plonelearning.theme
    zcml.load_config('configure.zcml', plonelearning.theme)
    ...
    ztc.installPackage('plonelearning.theme')
...
setup_product()
ptc.setupPloneSite(products=['plonelearning.theme'])
